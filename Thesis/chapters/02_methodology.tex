...
\begin{enumerate}
    ...
    \item \textbf{FR2: Remove Partial Class}: We remove a random 40\% subset of Class 1 (mimicking "right to be forgotten" for specific users).
    \item \textbf{FR3: Remove Multi-Class Subset}: We remove a random 40\% subset of both Class 0 and Class 3.
\end{enumerate}
